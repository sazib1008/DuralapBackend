...
class ConversationRequestService(
    ...
    fun createConversationRequest(
        ...
        // Publish event to notify recipient (safe against Kafka downtime)
        try {
            ...
            LoggerFactory.getLogger(ConversationRequestService::class.java).warn("Kafka notification skipped: ${e.message}")
        }
