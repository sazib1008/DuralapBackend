package com.example.duralap.search.controller

import com.example.duralap.database.dto.UserResponse
import com.example.duralap.database.model.toUserResponse
...
import com.example.duralap.search.service.SearchService
...
class SearchController(
    ...
    fun searchConversations(
        ...
        @RequestParam(required = false) cursor: String?,
        @RequestParam(defaultValue = "20") limit: Int
    ): ResponseEntity<SearchResponse<com.example.duralap.database.model.Conversation>> {
